...
def new_row():
    ...
    # all except a one row is tainted
    ...
    if first_row:
        ...
        SubjectTag = False 
        UniqueBody = fake.paragraph(nb_sentences=10, variable_nb_sentences=True)
        UniqueBodyTag = False 
        SentDateTime = fake.date_time_between(start_date="-10y")
        SentDateTimeTag = False
        Puser = sender[2]

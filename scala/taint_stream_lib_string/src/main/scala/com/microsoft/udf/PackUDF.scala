...
object PackUDF {
  val tagType = StringType
  val packString = (row_1: String, row_2: String) => {
    Row(row_1, row_2)
  }
  ...
  def packStringUDF() = {
    val returnType = StructType(
      ...
      StructField("tag", tagType, true) ::
      Nil
    )
    udf(packString, returnType)
  }

  val packBinary = (row_1: Array[Byte], row_2: String) => {
    Row(row_1, row_2)
  }
  ...
  val packBoolean = (row_1: Int, row_2: String) => {
    Row(row_1, row_2)
  }
  ...
  val packDate = (row_1: Any, row_2: String) => {
    Row(row_1, row_2)
  }
  ...
  val packTimestamp = (row_1: Any, row_2: String) => {
    Row(row_1, row_2)
  }
  ...
  val packDecimal = (row_1: Any, row_2: String) => {
    Row(row_1, row_2)
  }
  ...
  val packDouble = (row_1: Double, row_2: String) => {
    Row(row_1, row_2)
  }
  ...
  val packFloat = (row_1: Float, row_2: String) => {
    Row(row_1, row_2)
  }
  ...
  val packByte = (row_1: Byte, row_2: String) => {
    Row(row_1, row_2)
  }
  ...
  val packInteger = (row_1: Int, row_2: String) => {
    Row(row_1, row_2)
  }
  ...
  val packLong = (row_1: Long, row_2: String) => {
    Row(row_1, row_2)
  }
  ...
  val packShort = (row_1: Short, row_2: String) => {
    Row(row_1, row_2)
  }
  ...
  val packNull = (row_1: Any, row_2: String) => {
    Row(row_1, row_2)
  }
